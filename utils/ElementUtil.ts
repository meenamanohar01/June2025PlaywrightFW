...
export class ElementUtil{
    ...
    private page: Page;
    private defaultTimeOut: number = 99000;


    constructor(page: Page, timeOut: number = 99000) {
        this.page = page;
     ...
     * textContent() : get all text from DOM , even hidden or offscreen
     */
    ...
    /**
     * Get text context of an element
     * innerText() : get Visible text only (what the user actually sees with the style applied)
     */
